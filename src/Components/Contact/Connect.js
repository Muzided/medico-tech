          ...
          <div className=' pl flex px-10 flex-col lg:flex-row bg-white rounded-lg   shadow-lg overflow-hidden'>
             ...
             <div className=' lg:pl-12 lg:pr-0 md:py-12 lg:w-3/5 '>
                ...
                <form>
                    ...
                    <input type="text" placeholder= 'First Name' className='bg-[#CAF0F8] border w-full tracking-wide rounded-md  py-2 px-2' ></input>
                       
                    </div>
                    <div className='md:w-1/2 '>
                    <label for="large-input" class="block mb-2 font-bold  text-md text-black dark:text-white">Last Name</label>
                    <input type="text" placeholder= 'Last Name' className='bg-[#CAF0F8] border w-full  tracking-wide rounded-md  py-2 px-2' ></input>
                    ...
                    <input type="text" placeholder= 'Phone number' className='bg-[#CAF0F8] border w-full tracking-wide rounded-md first-letter:     py-2 px-2' ></input>
                    </div>
                    <div className='md:w-1/2'> 
                    <label for="large-input" class="block mb-2 font-bold  text-md text-black dark:text-white">Email</label>
                    <input type="text" placeholder= 'Email' className='bg-[#CAF0F8] border w-full tracking-wide rounded-md first-letter:    py-2 px-2' ></input>
                    </div>
                    ...
                    <input type="text" placeholder= 'Subject' className='bg-[#CAF0F8] border tracking-wide rounded-md first-letter:  py-2 px-2 w-full' ></input>
                    </div>
                    <div className='mt-5'>
                    <div class="mb-6">
    <label for="large-input" class="block mb-2 font-bold  text-md text-black dark:text-white">Message</label>
    <input type="text" id="large-input" placeholder='Message' class="bg-[#CAF0F8] block w-full p-4 text-gray-900 border rounded-md sm:text-md  focus:border-[#8CDCAD] dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" />
</div>
                       
                    </div>
                    <div className='mt-5'>
                        <button className='w-full rounded-lg font-bold tracking-widest
                         bg-primary hover:bg-secondary  text-white border-2 py-4'> Submit</button>
                    </div>
                </form>
             </div>

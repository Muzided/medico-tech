      ...
      <div className=' bg-primary py-12'>
        <div className='  bg-no-repeat flex flex-col items-center gap-6'>
          ...
          <div className='grid  grid-cols-12 gap-4 px-4'>
            ...
            <div className=' col-span-12 md:col-span-3   text-primary hover:bg-secondary  hover:text-white bg-white flex flex-col gap-4   items-center shadow-lg  rounded-lg md:p-10  py-8  px-8'>
            ...
            <div className='text-primary col-span-12 md:col-span-3  bg-white hover:bg-secondary hover:text-white flex flex-col gap-4 font-bold  items-center shadow-lg  rounded-lg md:p-10  py-8  px-8'>

              <RiMentalHealthLine size={72} />

              <h1 className='text-2xl text-center  '>Mental/Behavioral Health Services</h1>
            ...
            <div className='col-span-12 gap-4 md:px-4 grid grid-cols-1 md:grid-cols-3'>

...
const Achievements = () => {
  return (
    <div className='min-h-screen bg-img1 bg-cover'>
         ...
         <div className='flex flex-col md:flex-row md:justify-center md:w-5/6 md:pl-64 items-center md:min-h-screen gap-6'>
            <div className='flex flex-col items-center md:items-start gap-5 md:w-2/5 pr-4 '>

                <h1 className=' text-[#08485E] pt-4 text-sm md:text-md md:pt-0 font-bold'>ACHIEVEMENTS</h1>
                <h1 className=' text-3xl md:text-5xl font-bold pb-2 md:py-4 border-b-2 md:border-[#08485E]'> We've won awards</h1>
            ...
            <div className=' md:pl-4'>
                ...
                <div className= '   flex-col items-center flex shadow-xl py-6 pt-14  '>

...
const Footer = () => {
  ...
  return (
    <div className=' bg-[#0C5C24]  '>
        ...
        <div className='bg-white flex md:justify-center justify-evenly py-6 md:gap-12 text-[#229631] '>
               <h1 className='text-cGreen font-bold text-xs md:text-sm tracking-wider  hover:text-[#21C063]  border-white border-b-2 hover:border-[#21C063] cursor-pointer py-4'>Home</h1>
               <div onMouseEnter={handleMenu1} onMouseLeave={handleMenu1}  className='flex-col  space-y-5'>   
   <div  className=' flex  items-center text-xs md:text-sm gap-2 text-cGreen hover:text-[#21C063] border-white border-b-2 hover:border-[#21C063]' >
  ...
  <div className=' flex items-center gap-2 text-xs md:text-sm   text-cGreen hover:text-[#21C063]  border-white border-b-2 hover:border-[#21C063]' >
 ...
 <h1 className='text-cGreen font-bold text-xs md:text-sm tracking-wider  hover:text-[#21C063]  border-white border-b-2 hover:border-[#21C063] cursor-pointer py-4'> Contact </h1>

...
const KeyFeatures = (props) => {
  return (
    ...
    <h1 className='text-center lg:text-4xl md:text-2xl pt-2 pb-8 text-lg font-bold text-primary'> Key Features </h1>
    <div className='grid lg:grid-cols-3 grid-cols-1 gap-6 md:px-8   grid-rows-3 lg:grid-rows-1'>
    <div className='bg-white shadow-lg rounded-lg lg:py-6 py-4 flex flex-col text-primary/90 hover:scale-105 hover:shadow-xl cursor-pointer'>

...
const HelpDesk = () => {
  return (
    ...
    <h1 className='text-3xl md:text-6xl text-center font-bold pb-6 lg:pb-10 text-cGreen' > Front/Patient Help-Desk Services (RCM)</h1> 
    <p className='px-4 md:px-6 tracking-wide lg:px-8 text-sm lg:pb-10 pb-4 md:text-lg  text-center'>
   
    MedioTech's Front/Patient Help-Desk Services provide a welcoming and efficient point of contact, enhancing the patient experience with friendly assistance and streamlined service navigation.</p>
<KeyFeatures F1='Welcoming Point of Contact' F2='Efficient Service Navigation' F3='Proactive Issue Resolution' D1="

MedioTech's Help-Desk ensures a friendly and approachable first contact, creating a positive experience for patients."
D2="

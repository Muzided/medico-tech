...
const CashFlow = () => {
 ...
 <div className=' bg-mem5 flex py-4  flex-col lg:justify-center bg-cover bg-no bg-repeat'>
    ...
    <h1 className='text-3xl md:text-6xl text-center font-bold pb-6 lg:pb-10 text-cGreen' > Cash Flow Practices</h1> 
    <p className='px-4 md:px-6 tracking-wide lg:px-8 text-sm lg:pb-10 pb-4 md:text-lg  text-center'>
   
MedicoTech's Cash Flow Practices (RCM) Service optimizes revenue cycles with precision and efficiency. Our comprehensive solution enhances financial performance for healthcare providers, from claims processing to payment collection, ensuring a robust and consistent cash flow.</p>
...
MedicoTech streamlines processes from claims to payments, ensuring peak financial efficiency."
D2="

...
export const Home = () => {
  return (
    ...
    {/* HeroSection */}
          ...
          <div className='md:bg-white/30 md:py-40 md:px-48'>
          <div className='md:flex md:flex-col md:bg-white/60 md:w-6/12 md:px-10 md:rounded-lg md:pt-10 md:pb-14'>
          <h1 className=' text-[#08485E] tracking-widest md:tr  acking-wider md:block md:text-lg justify-center flex py-4 text-xs font-bold' > BETTER HEALTH </h1>
...
<div className='  justify-center flex py-2 rounded-md px-6 bg-[#0C5A23] '>
        <button className=' text-white text-lg font-semibold '>
          Discover More
            ...
            {/* About Us */}
          <div className='flex flex-col pt-6 md:flex-row md:justify-center gap-8'>
         ...
         <div  className='pb-20' >
         <div className='pl-32'>
         <div className='pl-96 -mb-32 pt-2'>
         ...
         <div className='bg-mem2 md:h-[81vh]  bg-cover  px-8 pb-2 md:pb-6  pt-8 '>
            <img className=' md:h-[75vh] rounded-lg' src={img } alt='eh'/>
         </div>

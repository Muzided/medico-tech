        ...
        <div className='  bg-no-repeat flex flex-col items-center gap-6'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 px-4'>
            ...
            <div className='text-primary  bg-white hover:bg-secondary hover:text-white flex flex-col gap-4 font-bold  items-center shadow-lg  rounded-lg md:p-10  py-8  px-8'>
              ...
              <h1 className='text-xl text-center  '>Mental/Behavioral Health Services</h1>
            ...
            <div className='text-primary bg-white hover:bg-secondary hover:text-white flex flex-col gap-4 font-bold  items-center shadow-lg  rounded-lg md:p-10  py-8  px-8'>
              ...
              <h1 className='text-xl text-center  '>Dental & Dentistry Services</h1>
            ...
            <div className='text-primary bg-white hover:bg-secondary hover:text-white flex flex-col gap-4 font-bold  items-center shadow-lg  rounded-lg md:p-10  py-8  px-8'>
              ...
              <h1 className='text-xl text-center '>Workers Compensation & Non-Fault claims</h1>
            ...
            <div className='text-primary hover:bg-secondary hover:text-white bg-white flex flex-col gap-4   items-center shadow-lg  rounded-lg md:p-10  py-8  px-8'>
              ...
              <h1 className='text-xl font-bold text-center '>Vision Care Services</h1>
            ...
            <div className='text-primary hover:bg-secondary hover:text-white bg-white flex flex-col gap-4 font-bold  items-center shadow-lg  rounded-lg md:p-10  py-8  px-8'>
              ...
              <h1 className='text-xl  text-center '>DME Services </h1>
            ...
            <div className='text-primary hover:bg-secondary hover:text-white bg-white flex flex-col gap-4   items-center shadow-lg  rounded-lg md:p-10  py-8  px-8'>
              ...
              <h1 className='text-xl font-bold text-center '>Home Health Care Services</h1>
              ...
              <h1 className='text-xl font-bold text-center '>Ambulatory Services</h1>
            ...
            <div className='text-primary hover:bg-secondary hover:text-white bg-white flex flex-col gap-4   items-center shadow-lg  rounded-lg md:p-10  py-8  px-8'>
              ...
              <h1 className='text-xl font-bold text-center '>Emergency Room Billing Services</h1>
            ...
            <div className='text-primary hover:bg-secondary hover:text-white bg-white flex flex-col gap-4   items-center shadow-lg  rounded-lg md:p-10  py-8  px-8'>
              ...
              <h1 className='text-xl font-bold text-center '>Radiology Services</h1>
          ...
          <div className='grid md:grid-cols-3 grid-cols-1 gap-4'>
            <div className='text-primary hover:bg-secondary hover:text-white bg-white flex flex-col gap-4   items-center shadow-lg  rounded-lg md:p-10  py-8  px-8'>
              ...
              <h1 className='text-xl font-bold text-center '>Laboratory Billing Services</h1>
            ...
            <div className='text-primary hover:bg-secondary hover:text-white bg-white flex flex-col gap-4   items-center shadow-lg  rounded-lg md:p-10  py-8  px-8'>
              ...
              <h1 className='text-xl font-bold text-center '>Pain Management Services</h1>
            ...
            <div className='text-primary hover:bg-secondary hover:text-white bg-white flex flex-col gap-4   items-center shadow-lg  rounded-lg md:p-10  py-8  px-8'>
              ...
              <h1 className='text-xl font-bold text-center '>Urgent Care Health Services</h1>
